...
This repo uses the same prompt *structure* across:
...
Each builder now returns a chat-style JSON conversation that can be passed
through ``processor.apply_chat_template(...)`` to obtain the final text
prompt for a specific checkpoint.
"""
