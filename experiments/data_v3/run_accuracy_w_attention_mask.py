"""
Run accuracy computation for vlm_levels_v3 dataset with visual relational questions,
...
def compute_accuracy_for_questions(
    ...
    """Run inference and compute accuracy for relational position questions with attention masking."""
    print(f"\n{'='*60}")
    print(f"Running visual_relational accuracy experiment WITH ATTENTION MASKING")
    print(f"QA Key: qa")
    ...
    # Add dataset name
    results_df["dataset"] = "vlm_levels_v3"
    ...
    filename = "visual_relational_results_w_mask.csv"
...
if __name__ == "__main__":
    ...
    print("\n" + "="*60)
    print("VLM_LEVELS_V3 RELATIONAL ACCURACY (WITH ATTENTION MASKING)")
    print("="*60)
